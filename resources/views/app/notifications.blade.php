                        ...
                        <form role="form" action="{{url('/notification_type')}}" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-6">
                                       sms <input type="radio" name="attendance" @if($notification_types[0]->type =='sms') checked @endif value="sms"  >
                                       voice <input type="radio" name="attendance" @if($notification_types[0]->type=='voice') checked @endif value="voice" >
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-6">
                                       sms <input type="radio" name="fess" @if($notification_types[1]->type=='sms') checked @endif required value="sms"  >
                                       voice <input type="radio" name="fess" @if($notification_types[1]->type=='voice') checked @endif required value="voice"  >
                                    </div>
                                </div>
                                </div>
