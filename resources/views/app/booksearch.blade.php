                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign  blue"></i></span>
                           {{ Form::select('type',['Academic'=>'Academic','Story'=>'Story','Magazine'=>'Magazine','Other'=>'Other'],request()->input('type'),['class'=>'form-control'])}}
                     </div>
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        {{ Form::select('class',$classes,request()->input('class'),['class'=>'form-control'])}}
                      </div>
                    </div>
                  </div>
                  <div class="col-md-2">
