        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div data-original-title="" class="box-header well">
                    <h2><i class="glyphicon glyphicon-book"></i> Student Attendance Report</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        <label for="dob">B-From</label>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                                            <input value="" type="text" id="b_form"  class="form-control " name="b_form"   >
                                        </div>
